...
foreach ( $addon['options'] as $i => $option ) {
	...
	if ( 'percentage_based' === $price_type ) {
		...
		$price_for_display = apply_filters( 'woocommerce_addons_add_price_to_name', true, $addon ) ? apply_filters(
	...
	?>
	<p class="form-row form-row-wide wc-pao-addon-wrap wc-pao-addon-<?php echo esc_attr( $option_id ); ?>">
		<input
			type="radio"
