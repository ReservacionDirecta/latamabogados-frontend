...
class WC_Product_Addons_Admin {
	...
	public function add_settings() {
		...
		add_settings_field( 'show_incomplete_subtotal_option', __( 'Show Incomplete subtotal', 'woocommerce-appointments' ), array( $this, 'show_incomplete_subtotal_option' ), 'show_incomplete_subtotal', 'show_incomplete_subtotal' );
	}
	...
	public function show_incomplete_subtotal_option() {
		...
		$html                    .= '<label for="show-incomplete-subtotal-label">' . esc_html( __( 'Show running subtotal, even if not all required add-on choices have been made.', 'woocommerce-appointments' ) ) . '</label>';
