        ...
        <div className="container-narrow">
          <div className="ma-top-horizontal">
            ...
            <div className="ma-header-content">
              <h2 className="ma-title">PROGRAMAR CONSULTA O SERVICIO LEGAL</h2>
            </div>
          </div>
          ...
          <div className="ma-grid-single">
            <div className="ma-card">
              ...
              <p className="ma-intro">
                BRINDAMOS ASESORÍA JURÍDICA ESPECIALIZADA Y GESTIÓN CORPORATIVA EN EE.UU. <br /> CON UN ENFOQUE PRÁCTICO Y ECONÓMICO PARA SUS CLIENTES Y ASUNTOS RELACIONADOS CON EE.UU.
              </p>
              ...
              <ul className="ma-features">
                <li>
                  ...
                  <span>CONSULTAS LEGALES 1/2 HORA: $50 USD.</span>
                </li>
                ...
                <li>
                  ...
                  <span>CONTRATACIÓN POR PROYECTOS: $100 USD POR HORA—5 HORAS MÍNIMAS.</span>
                </li>
                ...
                <li>
                  ...
                  <span>SERVICIOS CORPORATIVOS: FORMAMOS SOCIEDADES ANÓNIMAS Y ABRIMOS CUENTAS BANCARIAS EN EE.UU DESDE $500 USD, MAS GASTOS.</span>
                </li>
              </ul>
              ...
              <div className="ma-actions">
                ...
                >
                  <i className="fab fa-whatsapp"></i> PROGRAME SU CONSULTA O PROYECTO AHORA
                </button>
              </div>
            </div>
          </div>
