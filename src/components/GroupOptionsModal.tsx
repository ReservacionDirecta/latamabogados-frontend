      ...
      >
        ...
        <div className="modal-header">
          ...
          <p className="modal-subtitle">
            Formatos dinámicos diseñados para optimizar recursos y <br />{" "}
          ...
          {status === "success" ? (
            <div style={{ textAlign: "center", padding: "40px 20px" }}>
              ...
              <p style={{ color: "#666", marginBottom: "25px" }}>
                Hemos recibido tus datos correctamente. Te contactaremos pronto.
              </p>
            ...
            <>
                ...
                <li style={{ marginBottom: "24px" }}>
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        Nota: Se requiere un mínimo de 3 participantes por
                        sesión.
                      </p>
                    </div>
                  </div>
              ...
              <div
                className="ma-economic-footer"
                style={{
                  padding: "25px",
                  background: "rgba(142, 61, 74, 0.03)",
                  borderRadius: "16px",
                  border: "1px solid rgba(142, 61, 74, 0.1)",
                }}
              >
                <p
                  style={{
                ...
                <form onSubmit={handleSubmit} className="ma-mailchimp-form">
                  <div style={{ display: "grid", gap: "10px" }}>
                    <div className="form-group">
                      ...
                      >
                        CORREO ELECTRÓNICO{" "}
                        <span style={{ color: "var(--latam-maroon)" }}>*</span>
                      </label>
                      <input
                        type="email"
                        name="fields[email]"
                    ...
                    >
                      <div className="form-group">
                        ...
                        >
                          NOMBRE{" "}
                          <span style={{ color: "var(--latam-maroon)" }}>
                            *
                          </span>
                        </label>
                        <input
