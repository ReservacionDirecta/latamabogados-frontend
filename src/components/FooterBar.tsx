      ...
      <div className="ct-footer-top">
        <div className="ct-container">
          ...
          <div className="ct-footer-socials">
            ...
            <a href="https://www.instagram.com/latamabogadosusa" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            ...
            <a href="https://www.linkedin.com/company/latam-abogados/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
